...
enum
{
  ...
  c_error_TRDP_PD_PAGE_DESCR_TOO_SHORT,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_STRING_AS_NAME,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_INTEGER_AS_TYPE,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_INTEGER_AS_ARRAY_SIZE,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_INTEGER_AS_VARIABLE_COUNT,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_INTEGER_AS_STRING_LENGTH,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_ARRAY_AS_ARRAY_DESCR,
  c_error_TRDP_PD_PAGE_DESCR_EXPECTED_ARRAY_AS_STRUCT_DESCR,
  c_error_TRDP_PD_PAGE_DESCR_ARRAY_INVALID_VD_COUNT,
  c_error_TRDP_PD_PAGE_PACK_INVALID_VARIABLE_COUNT,
  c_error_TRDP_PD_PAGE_PACK_INVALID_DATA_SIZE,
  c_error_TRDP_PD_PAGE_PACK_INVALID_VARIABLE_TYPE,
  c_error_TRDP_PD_PAGE_PACK_INVALID_STRING_LENGTH,
