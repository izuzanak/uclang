...
{/*{{{*/
  ...
  {
    const_locations.push_blanks(159 + 115);
    location_s *cv_ptr = const_locations.data + (const_locations.used - (159 + 115));
...
@begin ucl_params
<
dialog_type:retrieve_integer
properties:c_bi_class_array
buttons:c_bi_class_array
>
method dialog
; @end
