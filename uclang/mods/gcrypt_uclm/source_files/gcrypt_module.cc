...
#define CREATE_GCRYPT_CIPHER_TYPE_BIC_STATIC(VALUE)\
  ...
  cv_ptr++;
    ...
    CREATE_GCRYPT_CIPHER_TYPE_BIC_STATIC(GCRY_CIPHER_3DES);    // lgtm [cpp/weak-cryptographic-algorithm]
    ...
    CREATE_GCRYPT_CIPHER_TYPE_BIC_STATIC(GCRY_CIPHER_DES_SK);  // lgtm [cpp/weak-cryptographic-algorithm]
    ...
    CREATE_GCRYPT_CIPHER_TYPE_BIC_STATIC(GCRY_CIPHER_ARCFOUR); // lgtm [cpp/weak-cryptographic-algorithm]
    CREATE_GCRYPT_CIPHER_TYPE_BIC_STATIC(GCRY_CIPHER_DES);     // lgtm [cpp/weak-cryptographic-algorithm]
