...
extern unsigned c_bi_class_shp_part;
...
enum
{
  ...
  c_error_SHP_HANDLE_READ_OBJECT_ERROR,
  c_error_SHP_OBJECT_INDEX_EXCEEDS_RANGE,
  c_error_SHP_PART_INDEX_EXCEEDS_RANGE,
};
...
// - class SHP_PART -
extern built_in_variable_s shp_part_variables[];
extern built_in_method_s shp_part_methods[];
extern built_in_class_s shp_part_class;
