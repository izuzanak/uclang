...
{/*{{{*/
  {
    ...
    c_modifier_public | c_modifier_final,
    bic_v8_engine_operator_binary_equal
  },
  {
    "is_dead#0",
...
bool bic_v8_engine_operator_binary_equal(interpreter_thread_s &it,unsigned stack_base,uli *operands)
{/*{{{*/
...
{/*{{{*/
  ...
  // - retrieve function -
  Handle<Value> hnd_fun = hnd_obj->Get(String::New(name,name_length));
