...
unsigned c_bi_class_pcre = c_idx_not_exist;

// - PCRE module -
EXPORT built_in_module_s module =
{/*{{{*/
  1,                      // Class count
  pcre_classes,          // Classes

  0,                      // Error base index
  5,                      // Error count
  pcre_error_strings,    // Error strings

  pcre_initialize,       // Initialize function
  pcre_print_exception,  // Print exceptions function
};/*}}}*/

// - PCRE classes -
built_in_class_s *pcre_classes[] =
{/*{{{*/
  &pcre_class,
};/*}}}*/

// - PCRE error strings -
const char *pcre_error_strings[] =
{/*{{{*/
  "error_PCRE_COMPILE_ERROR",
...
{/*{{{*/
  ...
  // - initialize pcre class identifier -
  c_bi_class_pcre = class_base_idx++;
...
{/*{{{*/
  ...
  {
  case c_error_PCRE_COMPILE_ERROR:
    fprintf(stderr," ---------------------------------------- \n");
    ...
    fprintf(stderr," ---------------------------------------- \n");
    break;
  case c_error_PCRE_NOT_COMPILED:
    fprintf(stderr," ---------------------------------------- \n");
    fprintf(stderr,"Exception: ERROR: in file: \"%s\" on line: %u\n",source.file_name.data,source.source_string.get_character_line(source_pos));
    print_error_line(source.source_string,source_pos);
    ...
    fprintf(stderr," ---------------------------------------- \n");
    break;
  case c_error_PCRE_WRONG_MATCH_COUNT:
    fprintf(stderr," ---------------------------------------- \n");
    fprintf(stderr,"Exception: ERROR: in file: \"%s\" on line: %u\n",source.file_name.data,source.source_string.get_character_line(source_pos));
    print_error_line(source.source_string,source_pos);
    ...
    fprintf(stderr," ---------------------------------------- \n");
    break;
  case c_error_PCRE_WRONG_MATCH_OFFSET:
    fprintf(stderr," ---------------------------------------- \n");
    fprintf(stderr,"Exception: ERROR: in file: \"%s\" on line: %u\n",source.file_name.data,source.source_string.get_character_line(source_pos));
    print_error_line(source.source_string,source_pos);
...
built_in_method_s pcre_methods[] =
{/*{{{*/
  {
    "operator_binary_equal#1",
    c_modifier_public | c_modifier_final,
    bic_pcre_operator_binary_equal
  },
  {
    "Pcre#1",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_Pcre_1
  },
  {
    "match#1",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_match_1
  },
  {
    "match#2",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_match_2
  },
  {
    "match_from#2",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_match_from_2
  },
  {
    "split#1",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_split_1
  },
  {
    "replace#2",
    c_modifier_public | c_modifier_final,
    bic_pcre_method_replace_2
  },
  {
    "to_string#0",
    c_modifier_public | c_modifier_final | c_modifier_static,
    bic_pcre_method_to_string_0
  },
  {
    "print#0",
    c_modifier_public | c_modifier_final | c_modifier_static,
    bic_pcre_method_print_0
  },
};/*}}}*/

built_in_variable_s pcre_variables[] =
{/*{{{*/
...
; @end
  ...
  else
  {
    ...
    exception_s::throw_exception(it,module.error_base + c_error_PCRE_COMPILE_ERROR,operands[c_source_pos_idx],src_0_location);
    return false;
  }
...
; @end
  ...
  if (re == nullptr)
  {
    exception_s::throw_exception(it,module.error_base + c_error_PCRE_NOT_COMPILED,operands[c_source_pos_idx],(location_s *)it.blank_location);
    return false;
  }
...
#endif
  {
    exception_s *new_exception = exception_s::throw_exception(it,module.error_base + c_error_PCRE_WRONG_MATCH_COUNT,operands[c_source_pos_idx],(location_s *)it.blank_location);
...
; @end
  ...
  {
    exception_s *new_exception = exception_s::throw_exception(it,module.error_base + c_error_PCRE_WRONG_MATCH_OFFSET,operands[c_source_pos_idx],(location_s *)it.blank_location);
...
{/*{{{*/
  BIC_TO_STRING_WITHOUT_DEST(
    string_ptr->set(strlen("Pcre"),"Pcre")
  );
