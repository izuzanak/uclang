...
unsigned UclVar::c_bi_vni_DELEGATE_CURRY_WRONG_PARAMETER_COUNT;
...
UclVar UclVar::Exception::DELEGATE_CURRY_WRONG_PARAMETER_COUNT = UclVar(NO_INIT());
...
#define UCLVAR_RETRIEVE_VARIABLE_NAME_IDX(ID,NAME) \
  ...
  if (a_modules[c_uclvar_module_base])
  {
    ...
    UCLVAR_RETRIEVE_VARIABLE_NAME_IDX(c_bi_vni_DELEGATE_CURRY_WRONG_PARAMETER_COUNT,"DELEGATE_CURRY_WRONG_PARAMETER_COUNT");
...
{/*{{{*/\
  ...
  if (a_modules[c_uclvar_module_base])
  {
    ...
    UCLVAR_RETRIEVE_STATIC_CONST(Exception,c_bi_class_Exception,DELEGATE_CURRY_WRONG_PARAMETER_COUNT);
