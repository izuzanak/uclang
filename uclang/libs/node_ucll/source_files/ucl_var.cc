...
UclVar UclVar::Exception::DELEGATE_PAPPLY_WRONG_PARAMETER_COUNT = UclVar(NO_INIT());
...
UclVar UclVar::Socket::SOL_SOCKET = UclVar(NO_INIT());
UclVar UclVar::Socket::SO_ERROR = UclVar(NO_INIT());
UclVar UclVar::Socket::SO_SNDBUF = UclVar(NO_INIT());
UclVar UclVar::Socket::SO_RCVBUF = UclVar(NO_INIT());
