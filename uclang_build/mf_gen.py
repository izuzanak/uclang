...
class module_c:
  ...
  #{{{
    ...
    self.mod_proj.target = "lib" + self.mod_proj.project_name
...
opt_build = "-std=c++11 -fPIC -Wno-class-memaccess " # -DNDEBUG
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = project_c(
      ...
      [ 
        "header_files",
        os.sep.join(["..","..","libs","base_ucll","header_files"]),
        os.sep.join(["..","..","libs","node_ucll","header_files"]),
      ],
      [ 
        "source_files",
      ],
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      ...
      [ 
        "header_files",
        os.sep.join(["..","base_ucll","header_files"]),
      ],
      [ 
        "source_files",
      ],
      [
        os.sep.join(["..","base_ucll"]),
      ],
      opt_build, # CXX options
      opt_link, # CXX link options
      "", # CXX defines
...
# channel module
cfg_ref = c_cfg[C_MODULE_CHANNEL]
# {{{
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      configuration,
...
# nanomsg module
cfg_ref = c_cfg[C_MODULE_NANOMSG]
# {{{
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      configuration,
      ...
      opt_build, # CXX options
      opt_link + "-lnanomsg ", # CXX link options
      "", # CXX defines
      [],
      [],
    )
...
# openssl module
cfg_ref = c_cfg[C_MODULE_OPENSSL]
# {{{
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      configuration,
      ...
      opt_build, # CXX options
      opt_link + "-lssl -lcrypto ", # CXX link options
      "", # CXX defines
      [],
      [],
    )
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      ...
      opt_build, # CXX options
      opt_link + "-lvlc ", # CXX link options
      "", # CXX defines
      [],
      [],
    )
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      ...
      opt_build, # CXX options
      opt_link + "-lva-x11 -lva ", # CXX link options
      "", # CXX defines
      [],
      [],
    )
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      ...
      opt_build, # CXX options
      opt_link + "-lraw -lstdc++ -fopenmp -llcms2 ", # CXX link options
      "", # CXX defines
      [],
      [],
    )
...
if cfg_ref[CFG_TARGET]:
    cfg_ref[CFG_MODULE] = module_c(
      ...
      [ 
        "header_files",
        os.sep.join(["..","..","libs","base_ucll","header_files"]),
        os.sep.join(["..","..","libs","ftgl_ucll","header_files"]),
      ],
      [ 
        "source_files",
      ],
