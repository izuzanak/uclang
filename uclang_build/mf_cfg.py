...
c_cfg = [
    ...
    ["LIB_FTGL"      ,False,C_UCLANG_DIR + "libs/libftgl_ucll"     ,None],
    ...
    ["MOD_MATH"      ,False,C_UCLANG_DIR + "mods/math_uclm"        ,None],
    ["MOD_PSQL"      ,False,C_UCLANG_DIR + "mods/psql_uclm"        ,None],
    ["MOD_SQLITE"    ,False,C_UCLANG_DIR + "mods/sqlite_uclm"      ,None],
    ["MOD_HTTP"      ,False,C_UCLANG_DIR + "mods/http_uclm"        ,None],
    ["MOD_WEBSOCKET" ,False,C_UCLANG_DIR + "mods/websocket_uclm"   ,None],
    ["MOD_CURL"      ,False,C_UCLANG_DIR + "mods/curl_uclm"        ,None],
    ...
    ["MOD_LLVM"      ,False,C_UCLANG_DIR + "mods/llvm_uclm"        ,None],
    ["MOD_AV"        ,False,C_UCLANG_DIR + "mods/av_uclm"          ,None],
    ["MOD_AO"        ,False,C_UCLANG_DIR + "mods/ao_uclm"          ,None],
    ["MOD_MPG"       ,False,C_UCLANG_DIR + "mods/mpg_uclm"         ,None],
    ["MOD_PORTAUDIO" ,False,C_UCLANG_DIR + "mods/portaudio_uclm"   ,None],
    ["MOD_GSTREAMER" ,False,C_UCLANG_DIR + "mods/gstreamer_uclm"   ,None],
    ["MOD_IMAGE"     ,True ,C_UCLANG_DIR + "mods/image_uclm"       ,None],
    ["MOD_OPENCV"    ,False,C_UCLANG_DIR + "mods/opencv_uclm"      ,None],
    ["MOD_DOCU"      ,True ,C_UCLANG_DIR + "mods/docu_uclm"        ,None],
    ["MOD_GLUT"      ,False,C_UCLANG_DIR + "mods/glut_uclm"        ,None],
    ["MOD_GLEW"      ,False,C_UCLANG_DIR + "mods/glew_uclm"        ,None],
    ["MOD_GL"        ,False,C_UCLANG_DIR + "mods/gl_uclm"          ,None],
    ["MOD_FTGL"      ,False,C_UCLANG_DIR + "mods/ftgl_uclm"        ,None],
    ["MOD_VG"        ,False,C_UCLANG_DIR + "mods/vg_uclm"          ,None],
    ["MOD_IMXEGL"    ,False,C_UCLANG_DIR + "mods/imxegl_uclm"      ,None],
    ["MOD_SNMP"      ,False,C_UCLANG_DIR + "mods/snmp_uclm"        ,None],
    ...
    ["MOD_SOAPCL"    ,False,C_UCLANG_DIR + "mods/soap/soapcl_uclm" ,None],
    ["MOD_SOAPSRV"   ,False,C_UCLANG_DIR + "mods/soap/soapsrv_uclm",None],
    ["MOD_PYTHON"    ,False,C_UCLANG_DIR + "mods/python_uclm"      ,None],
    ["MOD_V8"        ,False,C_UCLANG_DIR + "mods/v8_uclm"          ,None],
    ["MOD_UV"        ,False,C_UCLANG_DIR + "mods/uv_uclm"          ,None],
    ["MOD_FUSE"      ,False,C_UCLANG_DIR + "mods/fuse_uclm"        ,None],
